...
void Init_GMMobileUtilsImageTools()
{
    ...
    libHandle = ExtUtils_GetLibraryHandle("GMMobileUtilsImageTools.ext");
    if (libHandle)
    {
...
void Startup_GMMobileUtilsImageTools()
{
...
void Shutdown_GMMobileUtilsImageTools()
{
    if (!isInitialized) return;
