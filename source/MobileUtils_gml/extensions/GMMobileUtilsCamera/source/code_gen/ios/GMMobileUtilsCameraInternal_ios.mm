...
#import "GMMobileUtilsCameraInternal_ios.h"
...
@interface GMMobileUtilsCameraInternal ()
{
    gm::runtime::DispatchQueue __dispatch_queue;
    id<GMMobileUtilsCameraInterface> __impl;
}@end


@implementation GMMobileUtilsCameraInternal
...
+ (void)load
{
    ...
    Class base = [GMMobileUtilsCameraInternal class];
...
- (instancetype)init
{
    ...
    if (self)
    {
        __impl = (id<GMMobileUtilsCameraInterface>)self;
    }
    return self;
}
- (double)__EXT_NATIVE__mobile_utils_camera_open:(char*)__arg_buffer arg1:(double)__arg_buffer_length
{
    ...
    [__impl mobile_utils_camera_open:callback];
