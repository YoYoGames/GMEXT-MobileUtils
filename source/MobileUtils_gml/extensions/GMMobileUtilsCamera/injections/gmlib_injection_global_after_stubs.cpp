...
void Init_GMMobileUtilsCamera()
{
    ...
    libHandle = ExtUtils_GetLibraryHandle("GMMobileUtilsCamera.ext");
    if (libHandle)
    {
...
void Startup_GMMobileUtilsCamera()
{
...
void Shutdown_GMMobileUtilsCamera()
{
    if (!isInitialized) return;
