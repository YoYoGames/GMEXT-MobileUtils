...
void Init_GMMobileUtilsAppPopupSettings()
{
    ...
    libHandle = ExtUtils_GetLibraryHandle("GMMobileUtilsAppPopupSettings.ext");
    if (libHandle)
    {
...
void Startup_GMMobileUtilsAppPopupSettings()
{
...
void Shutdown_GMMobileUtilsAppPopupSettings()
{
    if (!isInitialized) return;
