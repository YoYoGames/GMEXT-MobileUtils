...
#import "GMMobileUtilsAppPopupSettingsInternal_ios.h"
...
@interface GMMobileUtilsAppPopupSettingsInternal ()
{
    gm::runtime::DispatchQueue __dispatch_queue;
    id<GMMobileUtilsAppPopupSettingsInterface> __impl;
}@end


@implementation GMMobileUtilsAppPopupSettingsInternal
...
+ (void)load
{
    ...
    Class base = [GMMobileUtilsAppPopupSettingsInternal class];
...
- (instancetype)init
{
    ...
    if (self)
    {
        __impl = (id<GMMobileUtilsAppPopupSettingsInterface>)self;
    }
    return self;
}
- (double)__EXT_NATIVE__mobile_utils_app_popup_settings_show:(char*)__arg_buffer arg1:(double)__arg_buffer_length
{
    ...
    [__impl mobile_utils_app_popup_settings_show:callback];

    return 0;
}

// Internal function used for fetching dispatched function calls to GML
- (double)__EXT_NATIVE__GMMobileUtilsAppPopupSettings_invocation_handler:(char*)__ret_buffer arg1:(double)__ret_buffer_length
{
