...
void Init_GMMobileUtilsVibrate()
{
    ...
    libHandle = ExtUtils_GetLibraryHandle("GMMobileUtilsVibrate.ext");
    if (libHandle)
    {
...
void Startup_GMMobileUtilsVibrate()
{
...
void Shutdown_GMMobileUtilsVibrate()
{
    if (!isInitialized) return;
