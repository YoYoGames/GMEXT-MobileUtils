...
#import "GMMobileUtilsGalleryInternal_ios.h"
...
@interface GMMobileUtilsGalleryInternal ()
{
    gm::runtime::DispatchQueue __dispatch_queue;
    id<GMMobileUtilsGalleryInterface> __impl;
}@end


@implementation GMMobileUtilsGalleryInternal
...
+ (void)load
{
    ...
    Class base = [GMMobileUtilsGalleryInternal class];
...
- (instancetype)init
{
    ...
    if (self)
    {
        __impl = (id<GMMobileUtilsGalleryInterface>)self;
    }
    return self;
}
- (double)__EXT_NATIVE__mobile_utils_gallery_open:(char*)__arg_buffer arg1:(double)__arg_buffer_length
{
    ...
    [__impl mobile_utils_gallery_open:callback];

    return 0;
}

// Internal function used for fetching dispatched function calls to GML
- (double)__EXT_NATIVE__GMMobileUtilsGallery_invocation_handler:(char*)__ret_buffer arg1:(double)__ret_buffer_length
{
