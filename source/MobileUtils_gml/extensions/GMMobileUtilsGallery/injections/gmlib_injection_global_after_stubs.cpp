...
void Init_GMMobileUtilsGallery()
{
    ...
    libHandle = ExtUtils_GetLibraryHandle("GMMobileUtilsGallery.ext");
    if (libHandle)
    {
...
void Startup_GMMobileUtilsGallery()
{
...
void Shutdown_GMMobileUtilsGallery()
{
    if (!isInitialized) return;
