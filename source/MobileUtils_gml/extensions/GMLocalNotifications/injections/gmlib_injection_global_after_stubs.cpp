...
void Init_GMLocalNotifications()
{
    ...
    libHandle = ExtUtils_GetLibraryHandle("GMLocalNotifications.ext");
    if (libHandle)
    {
...
void Startup_GMLocalNotifications()
{
...
void Shutdown_GMLocalNotifications()
{
    if (!isInitialized) return;
