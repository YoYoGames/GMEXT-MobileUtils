...
void Init_GMMobileUtilsNightMode()
{
    ...
    libHandle = ExtUtils_GetLibraryHandle("GMMobileUtilsNightMode.ext");
    if (libHandle)
    {
...
void Startup_GMMobileUtilsNightMode()
{
...
void Shutdown_GMMobileUtilsNightMode()
{
    if (!isInitialized) return;
